...
function validFunc(e,a,t,n,i,l,r,s,o){$(e).click(function(m){var u=$(a).val(),f=$(t).val(),d=$(n).val(),y=($(i).val(),$(l).val(),$(r).val(),/^[A-Za-zşŞıİçÇöÖüÜĞğ]+$/),c=/^[0-9]+$/;$(s),$(o);""==u?(swal({title:"Uyarı!",text:"Lütfen adınızı giriniz",type:"warning",confirmButtonText:"OK"}),m.preventDefault()):y.test(u)?""==f?(swal({title:"Uyarı!",text:"Lütfen soyadınızı giriniz",type:"warning",confirmButtonText:"OK"}),m.preventDefault()):y.test(f)?""==d?(swal({title:"Uyarı!",text:"Lütfen telefon numaranızı giriniz",type:"warning",confirmButtonText:"OK"}),m.preventDefault()):c.test(d)?$(e).click(function(){return!0}):(swal({title:"Uyarı!",text:"Lütfen geçerli bir telefon numarası giriniz",type:"warning",confirmButtonText:"OK"}),m.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir soyad giriniz",type:"warning",confirmButtonText:"OK"}),m.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir ad giriniz",type:"warning",confirmButtonText:"OK"}),m.preventDefault())})}$(document).ready(function(){document.body.className+=" is-loaded",$(".slider").slick({fade:!0,speed:2e3,cssEase:"ease-out",touchThreshold:100,arrows:!1,autoplay:!0,autoplaySpeed:3e3})}),validFunc("#submit","#ad","#soyad","#tel","#email","#proje","#mesaj","#ke","#kt"),$("#legalWarning").click(function(){swal({title:"Uyarı!",text:"Formda yer alan her türlü kişisel bilgimin, DKY pazarlama faaliyetlerinde, kampanyalarında, reklamlarında, tanıtımlarında ve iletişim çalışmalarında paylaşılmasına, işlenebilmesine, kullanılmasına, saklanmasına, tarafıma sms, mms, email gönderilmesine, sesli arama yapılmasına ve posta gönderilmesine muvafakat ediyor ve izin veriyorum.",type:"warning",confirmButtonText:"OK"})});
